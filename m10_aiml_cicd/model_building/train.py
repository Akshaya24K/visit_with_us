...
Xtrain_path = "hf://datasets/data2aihub/ds-visit-with-us/Xtrain.csv"
Xtest_path = "hf://datasets/data2aihub/ds-visit-with-us/Xtest.csv"
ytrain_path = "hf://datasets/data2aihub/ds-visit-with-us/ytrain.csv"
ytest_path = "hf://datasets/data2aihub/ds-visit-with-us/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "product_propensity_model_v1.joblib"
    ...
    repo_id = "data2aihub/model-visit-with-us"
    repo_type = "model"
    ...
    api.upload_file(
        path_or_fileobj="product_propensity_model_v1.joblib",
        path_in_repo="product_propensity_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )

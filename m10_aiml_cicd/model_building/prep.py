...
#DATASET_PATH = "hf://datasets/data2aihub/ds-visit-with-us/data/tourism.csv"
DATASET_PATH = "hf://datasets/data2aihub/ds-visit-with-us/tourism.csv"
...
for file_path in files:
    api.upload_file(
        ...
        repo_id="data2aihub/ds-visit-with-us",
        repo_type="dataset",
    )
